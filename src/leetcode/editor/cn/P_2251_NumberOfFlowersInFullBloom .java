...
// 
//
// Related Topics 数组 哈希表 二分查找 有序集合 前缀和 排序 👍 53 👎 0
 ...
 * @title 花期内花的数目
 * @author ouyang
 * @date 2023-09-28 00:20:15
 */

class P_2251_NumberOfFlowersInFullBloom{
	 public static void main(String[] args) {
	 	 //测试代码
	 	 Solution solution = new P_2251_NumberOfFlowersInFullBloom().new Solution();
	 }
