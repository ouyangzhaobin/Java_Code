 ...
 * @title 最深叶节点的最近公共祖先
 * @author ouyang
 * @date 2023-09-06 11:32:34
 */

class P_1123_LowestCommonAncestorOfDeepestLeaves{
	 public static void main(String[] args) {
	 	 //测试代码
	 	 Solution solution = new P_1123_LowestCommonAncestorOfDeepestLeaves().new Solution();
	 }
...
class Solution {
	...
	public Pair<TreeNode, Integer> find(TreeNode root) {
		if (root == null) {
