 ...
 * @title 全部开花的最早一天
 * @author ouyang
 * @date 2023-09-30 00:36:18
 */

class P_2136_EarliestPossibleDayOfFullBloom{
	 public static void main(String[] args) {
	 	 //测试代码
	 	 Solution solution = new P_2136_EarliestPossibleDayOfFullBloom().new Solution();
	 }
...
class Solution {
    public int earliestFullBloom(int[] plantTime, int[] growTime) {
		...
		List<Integer> id = new ArrayList<>(n);
		for (int i = 0; i < n; i++) {
			id.add(i);
		}
